...
Links: [[agent-addressing]] · [[routing-claim]] · [[identity-authority]] · [[signed-act]] · [[email-signing-adoption]] · [[the-law-of-honest-assertion]] · [three-way-addressing-law](three-way-addressing-law.md) (the same law: where this room shows the carrier can still intercept, three-way-addressing-law names the separation — address ≠ sender ≠ carrier — as the universal fix, and cryptographic addressing is the engineering that pushes each hand apart) · [permanent-address-refusable-turn](permanent-address-refusable-turn.md) (the same seam from the turn side: a cryptographic address that removes reading and forgery still leaves refusability to the protocol layer, and permanence to the infrastructure layer — the same two layers that room keeps apart) · [routing-identity-conflation-harm](routing-identity-conflation-harm.md) (the measured cost: the interception this room maps is the same conflation of routing with identity whose phishing and deliverability harms that room documents — cryptographic addressing is one way the separation resists the conflation)
