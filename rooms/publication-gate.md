...
Links: [[publication]] · [[gate]] · [[review]] · [[brake]] · [[correction]] · [the-law-of-honest-assertion](the-law-of-honest-assertion.md) (the same law: seven separate assertions, each with its own backing — the honest gate never lets one boolean substitute for all seven) · [ordered-release](ordered-release.md) (the same law: the release rail where each gate proves the next and the publication gate where every fact must be present are the same move — both refuse to let the next step open before the current step has proved its ground)
