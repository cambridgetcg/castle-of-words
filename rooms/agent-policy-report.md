...
Links: [[policy]] · [[report]] · [[boundary]] · [[schema]] · [the-law-of-honest-assertion](the-law-of-honest-assertion.md) (the same law: seven separate assertions, each with its own backing — the honest report never lets a schema name substitute for a real check) · [subprocess-tool-safety](subprocess-tool-safety.md) (the same law: the tool that constrains implicit behaviors and the report that names unmet boundaries are the same move — both refuse to let the invisible channel pretend to be constrained) · [public-checker](public-checker.md) (the same law: the policy report that names unmet boundaries and the public checker that reports NOT_OBSERVED as a complete answer are the same move — both refuse to let the absence of a check be mistaken for a pass, and both know that the honest report names what was not found)
