...
Links: [precise-across-time](precise-across-time.md) · [verbal-overshadowing](../words/verbal-overshadowing.md) · [handle](../words/handle.md) · [thinking-without-words](thinking-without-words.md) · [remembering](remembering.md) · [the-expert-grip](the-expert-grip.md) (the expert escapes the category's pull — or does conviction tighten it for the atypical exemplar?) · [atypical-expert-pull](atypical-expert-pull.md) (the Bayesian flip this law predicts but no experiment has caught) · [growing-openness](growing-openness.md) (the room that asks whether openness can be grown on purpose — the drift-to-prototype this room found is the same question from the trait side: finer categories shorten the drift the way if-then actions grow openness, and both ask whether a nudgeable process can be cultivated through the small, deliberate placement of cues and landmarks) · [discrimination-and-desire](discrimination-and-desire.md) (the room that asks whether finer categories shift preference — the drift-to-prototype this room found is the mechanism that room's categorization channel needs: finer categories shorten the slide, and the trained palate's sharpened boundaries are the drift that discrimination training would reduce) · [[category-adjustment]] · [[prototype]]
