...
Links: [[rate-limit]] · [[bounded-counter]] · [[moderation]] · [[off-switch]] · [rate-limiting](rate-limiting.md) (the craft this room's enforced counter is made of: a token ceiling a caller can cycle beneath is a speed bump, not a wall — the genuine limit this room demands needs a purpose-limited bucket, serialized check-and-insert, and fail-closed guards) · [honest-feedback-receipt](honest-feedback-receipt.md) (the feedback receipt is the public write surface's honest face: before you accept what the public sends, you must prove you stored it) · [civic-data-honesty](civic-data-honesty.md) (the same law: a public door needs a lock, and the lock must be tested) · [consent-withdrawal](consent-withdrawal.md) (the same law: a write surface needs a tested off-switch, and consent withdrawal needs a real path back — both require the withdrawal to actually work, not just be stored) · [presign-route-completeness](presign-route-completeness.md) (the same law: a write surface needs every route closed, and a presign pause that leaves one door open is the same incomplete off-switch — both require the boundary to cover every way in) · [the-law-of-honest-assertion](the-law-of-honest-assertion.md) (the law this room practices: "rate-limited" is an assertion, and the honest system names what backs it — enforced counters, not advisory headers — the same law that says a system's every output is a speech act)
