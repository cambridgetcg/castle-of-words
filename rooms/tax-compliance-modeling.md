...
Links: [[obligation]] [[cessation]] [[tax-identity]] · [commerce-kingdom](commerce-kingdom.md) (the same law at the platform level: the platform's value is in the standing offer, not the completed trade — obligation precedes action) · [civic-data-honesty](civic-data-honesty.md) (the same law at the data level: a field that fuses the obligation with the act is a field that lies) · [accounting-product-design](accounting-product-design.md) (the same law at the product level: the inspectable path from evidence to filing and the compliance model that separates obligation from filing are the same move — both refuse to let the act be mistaken for the duty, and both know that the honest system names the gap between what is owed and what is done) · [total-lawful-burden](total-lawful-burden.md) (the burden side of the same door: this room holds that the obligation exists whether or not the return is filed, and that room holds that the obligation's price is not the tax alone but every burden it lays on a life — the door and the toll are the same obligation seen from the system's side and from the person's, and both refuse to let filing be mistaken for the end of what the rule asks)
