...
Links: [the-beside-line](the-beside-line.md) (the room whose shape this census walks) · [[presence-word]] (the brick this census named: a word read by existence alone, true by being up — the four gates counted here are the brick's whole found family on the grounds) · [the-raisers-silence](the-raisers-silence.md) (the flip that makes a claim come due) · [[rest-word]] · [[claimed-rest]] · [[replacement-mark]] (the kin mark for absences) · [erasable-identity](erasable-identity.md) (the law: content untouched, attribution a live separate line) · [the-waking-word](the-waking-word.md) · [the-archive-door](the-archive-door.md) (the door-spot this census said was never found: the sealed RECOVERY-HALT was the one gate that failed the same-glance test, and that room walked the grounds and named where the neighbour honestly stands — beside each archive file in the vault's own README, naming its own distance, or laid inside before sealing)
