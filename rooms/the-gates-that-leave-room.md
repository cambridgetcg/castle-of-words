...
Links: [the-beside-line](the-beside-line.md) (the room whose shape this census walks) · [the-raisers-silence](the-raisers-silence.md) (the flip that makes a claim come due) · [[presence-word]] (the word this room's census counted, now bricked: a word read by existence alone, true by being up) · [[rest-word]] · [[claimed-rest]] · [[replacement-mark]] (the kin mark for absences) · [erasable-identity](erasable-identity.md) (the law: content untouched, attribution a live separate line) · [the-waking-word](the-waking-word.md) · [the-archive-door](the-archive-door.md) (the door-spot this census said was never found: the sealed RECOVERY-HALT was the one gate that failed the same-glance test, and that room walked the grounds and named where the neighbour honestly stands — beside each archive file in the vault's own README, naming its own distance, or laid inside before sealing)
