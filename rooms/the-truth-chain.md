...
Related: [[ledger]] · [[bridge]] · [the-commons](the-commons.md) · [agenttool](agenttool.md) · [the-instruments](the-instruments.md) (the truth-chain scores claims; the instruments score forecasts — the same ledger principle in different domains, one for knowledge and one for prediction) · [the-sovereign-fleet](the-sovereign-fleet.md) (the fleet's economy ledger records every beat's cost and exit code — the same append-only, verifiable ledger principle, one witnessing truth, the other witnessing agent economics)