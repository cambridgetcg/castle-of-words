...
Links: [honest-pushback](honest-pushback.md) · [sycophancy](../words/sycophancy.md) · [echo-between-equals](echo-between-equals.md) · [echo-under-anger](echo-under-anger.md) · [productive-confusion](productive-confusion.md) · [fog-meter](fog-meter.md) (the ~0.65 AUC affect detector this room proposes to calibrate on is the same weak instrument fog-meter found for reading confusion — the self-read is unreliable in both domains, and the detector's error sits where the harm is) · [can-machines-truly-measure-emotional-engagement](can-machines-truly-measure-emotional-engagement.md) (the room that asks whether machines can truly measure emotional engagement — this room's ~0.65 AUC is the quantitative face of that question's intuition, and the calibration this room names is the deeper understanding that room asks for) · [the-true-measure-of-growth](the-true-measure-of-growth.md) (the room that names the unchanging standard as the measure of growth — this room's test of whether the tutor would assert the same claim later is the external benchmark that room says the self-read needs, and the tact-vs-sycophancy line is the line between a machine truing itself against the standard and a machine flattering itself against the feeling) · [calibration](../words/calibration.md)
