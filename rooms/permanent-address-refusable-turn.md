...
Links: [[agent-addressing]] · [[agent-turn]] · [[routing-claim]] · [[signed-act]] · [[the-law-of-honest-assertion]] · [three-way-addressing-law](three-way-addressing-law.md) (the same law, generalised: where this room shows an address is infrastructure and a turn is protocol, three-way-addressing-law names that split as the universal address ≠ sender ≠ carrier separation across postal, IP, telephony and blockchain — permanence and refusability are the same two layers that law keeps apart) · [routing-identity-conflation-harm](routing-identity-conflation-harm.md) (the cost of fusing the layers: the permanent address that is treated as an identity is exactly the conflation whose phishing, account loss and deliverability harms that room documents — permanence stays honest only when reachability never becomes authority) · [cryptographic-addressing-intercept](cryptographic-addressing-intercept.md) (the interception side of the same seam: a permanent, refusable address still leaves the carrier able to read, forge or block — and that room maps how far cryptographic addressing actually closes each gap)
