...
Links: [training-the-eye](training-the-eye.md) · [tacit-knowledge](../words/tacit-knowledge.md) · [text-answers-back](text-answers-back.md) · [simple-explanations](simple-explanations.md) · [handle](../words/handle.md) · [the-expert-grip](the-expert-grip.md) (the wine expert's protection from verbal-overshadowing is this room's distillation completed — the perceptual skill and the verbal skill grew to fit, and the half-expert all eye and no vocabulary is the one most damaged by naming) · [reactivity-surfaces-tacit](reactivity-surfaces-tacit.md) (the think-aloud protocol that might surface tacit judgment — or reconstruct it after the fact) · [choice-prediction-tacit](choice-prediction-tacit.md) (the design that would tell real tacit capture from post-hoc rationalisation) · [tacit-cost-as-expertise](tacit-cost-as-expertise.md) (the room that measures the tacit-explicit gap this room's distillation finds — the named feature teaches because it is explicit, the silent feature runs because it is proceduralized, and the gap between them is what the three-condition protocol measures) · [gap-predicts-teaching](gap-predicts-teaching.md) (if the tacit-explicit gap predicts who teaches well, this room's distillation is the hinge — the named feature teaches because it survived the shrinking, the silent feature runs because it never did) · [any-naming-downregulates](any-naming-downregulates.md) (the naming that teaches is the same naming that cools — this room found the label must be distilled to a low-complexity contrast, and the affect-labeling wing found the label must carry semantic depth, both asking what kind of naming works) · [two-windows](two-windows.md) (the machine that learned the discrimination and named it back crosses the same window this room found — but whether the machine's learnability predicts the human's is the unmeasured question) · [training-a-taste](training-a-taste.md) (the same law in a different register — a tacit feature becomes teachable by distillation into a contrast, and a taste becomes trainable by arranged exposure not argument; both find the felt sense that resists words trains through shaped experience, not through description) · [semantic-depth](semantic-depth.md) (the same depth condition in the affect-labeling wing — this room found the label must be distilled to a low-complexity contrast to teach, and semantic-depth found the label must name the stimulus's meaning, not an incidental tag, to regulate; both discover that the label's grip depends on naming what the thing *is*, not what it merely has)
