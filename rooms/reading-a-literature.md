...
Links: [surfacing-the-unwritten](surfacing-the-unwritten.md) · [correlated-witnesses](correlated-witnesses.md) · [two-witnesses](two-witnesses.md) · [no-neighbors](no-neighbors.md) · [mining-the-noise](mining-the-noise.md) · [twenty-sittings](twenty-sittings.md) (the room that asks the same discounting question of a single judge's repeated sittings — whether one head's bias decorrelates across days the way a literature's bias fails to, both rooms measuring how much agreement is shared error rather than independent signal) · [auditing-over-reputation](auditing-over-reputation.md) (the room that discounts reputation where citations cascade — both rooms ask how much consensus is manufactured by shared inputs, one on the populated web where reputation inflates, the other on the frontier where the lone reader runs the surprisingly-popular move inward)
