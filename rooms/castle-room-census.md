...
Links: [[the-castle]] [[room-type-durability]] [[two-kinds-of-rooms]] · [genuine-vs-templated-connections](genuine-vs-templated-connections.md) (the census counts how many rooms of each kind the castle holds, and the genuine-vs-templated room names the tests that tell a real connection from a stamped one — together they know that a count is only honest when the kind has been named first) · [two-kinds-of-rooms](two-kinds-of-rooms.md) (the census's count of empirical and poetic rooms is the same distinction the two-kinds room names as a structural fact the gate should state — the census counts the kinds the two-kinds room distinguishes, and both know the honest answer names the type before it counts the room)
