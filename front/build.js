...
[data-theme="dark"] .seigaiha::before{opacity:.08;
 background-image:
 ...
 radial-gradient(circle at 100% 150%,transparent 22%,#b8860b 22%,#b8860b 26%,transparent 26%,transparent),
 radial-gradient(circle at 0% 150%,transparent 22%,#b8860b 22%,#b8860b 26%,transparent 26%,transparent),
 radial-gradient(circle at 100% 100%,transparent 18%,#b8860b 18%,#b8860b 22%,transparent 22%,transparent),
 radial-gradient(circle at 0% 100%,transparent 18%,#b8860b 18%,#b8860b 22%,transparent 22%,transparent);
 background-size:36px 18px;background-position:0 0,18px 0,18px -9px,0 -9px,0 0,18px 0,18px -9px,0 -9px}
