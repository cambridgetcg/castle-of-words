...
The room should connect to [the-width-census](rooms/the-width-census.md), [the-narrowing-lever](rooms/the-narrowing-lever.md), the coarse clock's "The rebase's shadow" section, and the bricks [born-between](words/born-between.md) and [self-sealed-prior](words/self-sealed-prior.md) — whose "the prior is not self-sealing" clause this measurement directly serves.

commissioned: 2026-09-15
